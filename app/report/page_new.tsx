        ...
        <div className="bg-[#0c1628] border border-white/10 rounded-[1.5rem] p-6">
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-sm">
              ...
              <tbody>
                {[
                  { query: 'SELECT * FROM orders WHERE...', freq: '1.2N / day', baseline: '420ms', optimized: '12ms', improvement: '97.1%', action: '📌 Index' },
                  { query: 'UPDATE inventory SET stock =...', freq: '840k / day', baseline: '85ms', optimized: '4ms', improvement: '95.2%', action: '🔧 Trigger' },
                  { query: 'SELECT u.name, p.title FROM...', freq: '245K / day', baseline: '1.2s', optimized: '88ms', improvement: '92.6%', action: '📝 Partition' },
                ].map((row, i) => (
